...
$args      = $args ?? null; // $args ?? null == isset($args) && $args ? $args : null
    ...
    <div class="text-sm lg:flex-grow">
		<?php foreach ( $menuItems as $item ): ?>
            ...
            <div class="relative group lg:inline-block">
              ...
              <div
                  class="items-center absolute border border-t-0 rounded-b-lg p-1 bg-white p-2 invisible group-hover:visible w-auto">
				  <?php foreach ( $item->children as $child ): ?>
                    <a href="<?php echo $child->url ?>"
                       class="px-4 py-2 block text-black hover:bg-grey-lighter"><?php echo $child->title ?></a>
				  <?php endforeach; ?>
